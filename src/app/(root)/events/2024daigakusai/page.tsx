...
const bandSchedule = [
  ...
  { date: "2024-10-13", name: "きゃのん公園", start: "13:50", end: "14:10" },
  { date: "2024-10-13", name: "0 痔 SAN KAN-CHI GRADUAT", start: "14:10", end: "14:30" },
  { date: "2024-10-13", name: "maaiskin", start: "14:30", end: "14:50" },
  { date: "2024-10-13", name: "apricot", start: "14:50", end: "15:10" },
  { date: "2024-10-13", name: "凛として林業", start: "15:10", end: "15:30" },
  { date: "2024-10-13", name: "クロレキシ団", start: "15:30", end: "15:50" },
    ...
    <div className="relative bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 min-h-screen py-6 sm:py-8 lg:py-12">
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="mb-12 sm:mb-16 bg-white bg-opacity-80 p-6 rounded-lg shadow-lg">
          ...
          <ul className="text-base sm:text-lg text-gray-700 mb-4 list-disc list-inside break-words">
            <li>日時：10月13日(日)/14日(月・祝) 9:30～15:00</li>
